        ...
        >
          ...
          >
            ...
            <div className="space-y-3">
              ...
              <button
                onClick={() => {
                  if ((window as any).electronAPI?.navigateTo) {
                    (window as any).electronAPI.navigateTo('wifi-settings');
                  }
                  setShowModal(false);
                }}
                className="w-full flex items-center gap-3 px-4 py-3 bg-[var(--surface-secondary)] hover:bg-[var(--border)] rounded-lg transition-colors text-left"
              ...
              <button
                onClick={async () => {
                  ...
                  // Use router to navigate in Electron
                  if ((window as any).electronAPI?.navigateTo) {
                    await (window as any).electronAPI.navigateTo('/login');
                  } else {
