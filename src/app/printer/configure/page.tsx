...
export default function PrinterConfigurePage() {
  ...
  const StatusMessage = ({ status }: { status: StatusMessage | null }) => {
    ...
    return (
      <div className={`${alertClass[status.type]} mt-4`}>
  ...
  if (!isElectron) {
    return (
      <div className="page-shell p-8" data-testid="printer-electron-warning">
        <div className="card max-w-2xl mx-auto p-8">
          <div className="flex items-center gap-3 mb-4">
            <svg className="w-10 h-10 text-[var(--status-warning-text)]" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z" />
            </svg>
            <h1 className="text-3xl font-bold text-primary">Electron Required</h1>
          </div>
  ...
  return (
    <div className="page-shell" data-testid="printer-configure-page">
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="mb-6 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted mt-1">Configure and manage your Bambu Lab printer</p>
            </div>
          </div>
          <a
            href="/print-queue"
        ...
        {/* Tabs */}
        <div className="flex space-x-2 mb-6 border-b border-[var(--border)]">
          ...
          <div className="space-y-6">
            <div className="card p-6">
              ...
              <div>
                ...
                <span className="font-mono text-muted">{factoryUrl}</span>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium mb-2">
                    Serial Number: <span className="text-[var(--status-error-text)]">*</span>
                  </label>
                  <input
                    type="text"
                    value={config.serial}
                  ...
                  />
                  <small className="text-muted">Required for printer authentication</small>
                </div>

                <div>
                  <label className="block text-sm font-medium mb-2">
                    Access Code: <span className="text-[var(--status-error-text)]">*</span>
                  </label>
                  <input
                    type="text"
                  ...
                  />
                  <small className="text-muted">8-digit code from Settings → Network on your printer</small>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="input-field"
                  />
                  <small className="text-muted">Optional - will be detected automatically</small>
                </div>
                ...
                <details className="mt-4">
                  ...
                  <div className="mt-4">
                    ...
                    <input
                      ...
                      className="input-field"
                    />
                    <small className="text-muted">Only set this if auto-discovery fails</small>
                  </div>
                </details>
              </div>
            ...
            <div className="card p-6">
              ...
              <p className="text-sm text-muted space-y-2">
              ...
              {isStreaming && currentStatus && (
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-[var(--surface-secondary)] rounded p-4">
                  ...
                  {currentStatus.printJob.active && (
                    <div className="bg-[var(--surface-secondary)] rounded p-4">
                      ...
                      <div className="w-full bg-[var(--border)] rounded-full h-4 mb-2">
                        <div
