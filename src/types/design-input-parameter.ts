...
export interface TextInputParameter extends BaseInputParameter {
  InputType: 'Text';
...
export interface NumericInputParameter extends BaseInputParameter {
 ...
 */
export type inputParameterSchema = InputParameter[];

/**
 * Validation helper functions
 */
export const InputParameterValidation = {
  /**
   ...
   */
  isValidTextParameter: (param: TextInputParameter): boolean => {
   ...
   */
  isValidNumericParameter: (param: NumericInputParameter): boolean => {
